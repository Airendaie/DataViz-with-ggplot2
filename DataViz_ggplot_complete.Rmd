...
This is a workbook (with answers) to accompany the Data Methods Club session on visualising data in R using ggplot2.
...
```{r install-tidyverse, echo=FALSE, eval=FALSE}
