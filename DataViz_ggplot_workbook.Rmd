---
title: "Data Viz with ggplot2 - workbook"
author: "Kate Dubarry"
date: "13/06/2023"
output: html_document
---

This is a workbook to accompany the Data Methods Club session on visualising data in R using ggplot2.

Content and dataset adapted from the Data Carpentries
...
- classic charts 'map' 1 variable to $x$ and 1 to $y$
- ggplot can map multiple variables to **aesthetics** -> geoms (shapes) & colour
- ggplot2 cheatsheet is the perfect resource for this: [`Cheat Sheet`](https://rstudio.github.io/cheatsheets/html/data-visualization.html?_gl=1*1j9c0u4*_ga*MTE1MzA0OTEyOS4xNjg1MDExNzg2*_ga_2C0WZ1JHG0*MTY4NjczNTg4NS4yLjEuMTY4NjczNzA0MS4wLjAuMA..)
...
#Try one of more of the above challenges here
